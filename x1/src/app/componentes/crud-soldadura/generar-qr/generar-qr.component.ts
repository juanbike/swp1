...
export class GenerarQrComponent implements OnDestroy {
  ...
  */
  ...
  ngOnDestroy(): void {
    // Anulación de suscripciones u otras tareas de limpieza
    if (this.soldaduraService) {
      console.log('Componente hijo destruido servicios');
      this.soldaduraService.unsubscribe();
    }
    //libera otros recursos de la clase
